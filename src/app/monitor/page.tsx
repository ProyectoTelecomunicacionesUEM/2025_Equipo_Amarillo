...
// 1. Definimos la estructura clara de un evento para evitar el 'any'
interface EventLog {
  id: string;
  device: string;
...
interface MonitorData {
  ...
  events: EventLog[]; // Cambiado de unknown[] a EventLog[]
}
...
export default function MonitorPage() {
  ...
  const fetchData = async () => {
    // Solo mostramos el estado de carga total la primera vez
