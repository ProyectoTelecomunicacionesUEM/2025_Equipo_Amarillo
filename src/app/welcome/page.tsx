  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-16 space-y-8">
      <section className="space-y-2">
        ...
        <h1 className="text-4xl font-semibold">¡Bienvenido a LOTCAR, {displayName}!</h1>
        <p className="text-gray-600">
          Descubre la libertad de movilidad con LOTCAR. Guarda esta página como tu punto de partida 
          para acceder rápidamente a tus reservas y gestionar tus alquileres de vehículos.
        </p>
      </section>

      <section className="rounded-xl border border-gray-200 bg-white/60 p-6 shadow-sm">
        <h2 className="text-lg font-medium mb-4">Tu cuenta LOTCAR</h2>
        <ul className="space-y-2 text-gray-700">
          ...
          <li>
            <span className="font-semibold">ID de cliente:</span> {userId}
          </li>
        </ul>
      </section>
      ...
      <section className="grid gap-4 md:grid-cols-2">
        <article className="rounded-xl border border-gray-200 bg-white/60 p-5 shadow-sm">
          ...
          <p className="text-sm text-gray-600">
            Explora nuestro catálogo de vehículos y reserva tu próximo coche de alquiler. 
            Compara precios, características y disponibilidad para encontrar el vehículo perfecto para ti.
          </p>
        </article>
        <article className="rounded-xl border border-gray-200 bg-white/60 p-5 shadow-sm">
          <h3 className="text-base font-semibold mb-2">Ventajas exclusivas</h3>
          <ul className="list-disc pl-5 text-sm text-gray-600 space-y-1">
            <li>Acceso prioritario a vehículos premium</li>
            <li>Descuentos especiales para clientes frecuentes</li>
            <li>Asistencia 24/7 durante tus desplazamientos</li>
            <li>Reservas flexibles sin penalizaciones</li>
          </ul>
        </article>
      </section>
    </main>
